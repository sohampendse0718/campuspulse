...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      >
        {/* Subtle purple radial glow behind robot */}
        <div style={{
          position: 'absolute', top: '50%', left: '50%',
          transform: 'translate(-50%, -50%)',
          width: 480, height: 480,
          background: 'radial-gradient(circle, rgba(139,92,246,0.18) 0%, rgba(0,229,255,0.07) 45%, transparent 70%)',
          pointerEvents: 'none',
        }} />

        {/* Floor shadow / spotlight */}
        <div style={{
          position: 'absolute',
          bottom: '24%', left: '50%',
        ...
        <div style={{ width: '100%', maxWidth: 420, height: 480, position: 'relative', zIndex: 1 }}>
          <RobotScene />
        </div>
      </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <button
              ...
              onMouseEnter={e => { if (!loading) { (e.currentTarget as HTMLElement).style.background = '#00B8CC'; (e.currentTarget as HTMLElement).style.boxShadow = '0 0 25px rgba(0,229,255,0.35)' } }}
              onMouseLeave={e => { if (!loading) { (e.currentTarget as HTMLElement).style.background = '#00E5FF'; (e.currentTarget as HTMLElement).style.boxShadow = 'none' } }}
            >
              {loading ? (
                <>
